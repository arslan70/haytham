...
> Review all available Haytham phase output in `.haytham/session/` for cross-stage consistency. Follow your instructions exactly. Emit the findings table and any high-confidence inconsistency calls inline. Write the structured summary to `.haytham/session/reviews/consistency.json`.
